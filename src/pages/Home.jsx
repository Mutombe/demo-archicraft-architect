      ...
      {[...Array(14)].map((_, i) => (
        <div
          ...
          style={{
            ...
            height: '1px',
            background: `linear-gradient(90deg, transparent, rgba(5,150,105,${Math.random() * 0.35 + 0.1}), transparent)`,
            left: `${Math.random() * 100}%`,
            top: `${Math.random() * 100}%`,
            animation: `leaf-drift ${Math.random() * 4 + 3}s linear infinite`,
...
function HeroSection() {
  ...
  return (
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
      ...
      <div className="absolute top-[10%] left-0 w-[3px] h-40 sm:h-56 bg-gradient-to-b from-transparent via-emerald-600 to-transparent z-20" />
        ...
        {heroImages.map((_, i) => (
          <button
            ...
            className={`w-[3px] transition-all duration-700 ${
              i === currentSlide ? 'h-10 bg-emerald-600' : 'h-4 bg-white/20 hover:bg-white/40'
            }`}
      ...
      >
        ...
        <motion.div
          ...
          className="w-20 h-[3px] bg-gradient-to-r from-emerald-600 to-emerald-500/50 mb-6 origin-left"
        />
        ...
        <motion.p
          ...
          className="text-emerald-500 text-xs sm:text-sm font-semibold uppercase tracking-[0.3em] mb-8"
        ...
        <div className="overflow-hidden">
          {['ARCHICRAFT', 'ARCHITECT.'].map((line, i) => (
            <motion.div
              key={line}
              initial={{ y: '110%' }}
              animate={{ y: 0 }}
            ...
            >
              <h1
                ...
                style={{
                  ...
                  fontWeight: line === 'ARCHITECT.' ? 700 : 300,
                }}
              >
                {line}
              </h1>
        ...
        >
          <div className="w-8 h-[1px] bg-emerald-600/40" />
        ...
        >
          <Link
            to="/contact"
            className="group relative inline-flex items-center gap-3 bg-emerald-600 text-navy-950 px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold transition-all duration-500 hover:bg-emerald-500 hover:shadow-xl hover:shadow-emerald-600/20"
            style={{ fontFamily: 'var(--font-sans)' }}
          >
            {hero.ctaPrimary}
          ...
          <Link
            to="/services"
            className="group inline-flex items-center gap-3 border border-white/20 text-white px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold transition-all duration-500 hover:border-emerald-600/50 hover:text-emerald-500 hover:bg-white/5"
            style={{ fontFamily: 'var(--font-sans)' }}
          >
            {hero.ctaSecondary}
          </Link>
...
function ServiceMarquee() {
  const routes = ['RESIDENTIAL', 'COMMERCIAL', 'LANDSCAPE', 'INTERIORS', 'SUSTAINABLE', 'MODERN', 'TRADITIONAL', 'MIXED USE', 'RENOVATION'];
  const repeated = [...routes, ...routes, ...routes, ...routes];

  return (
    <section className="bg-navy-950 border-y border-emerald-600/10 py-5 sm:py-6 overflow-hidden">
      <div className="animate-marquee flex whitespace-nowrap">
        {repeated.map((item, i) => (
          <span key={i} className="flex items-center gap-6 sm:gap-8 mx-6 sm:mx-8">
            <span className="text-emerald-600/80 font-heading text-lg sm:text-2xl tracking-wider uppercase font-semibold">
              {item}
            </span>
            <Leaf size={14} weight="fill" className="text-emerald-600/20 rotate-90" />
          </span>
        ))}
      </div>
    </section>
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
            <div>
              <p className="text-emerald-600/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>What We Create</p>
              <h2 className="font-heading text-white leading-[0.92]" style={{ fontSize: 'clamp(2rem, 4.5vw, 3.5rem)' }}>
                Our <span className="text-emerald-600">Designs</span>
              </h2>
            </div>
            <Link
              to="/services"
              className="group text-white/30 text-xs uppercase tracking-[0.2em] flex items-center gap-2 hover:text-emerald-600 transition-colors"
              style={{ fontFamily: 'var(--font-sans)' }}
            >
              All Services
              ...
              >
                ...
                >
                  ...
                  <div className="absolute top-4 right-5 z-10">
                    <span className="text-emerald-600/10 font-heading text-6xl sm:text-7xl leading-none font-bold">
                      {String(i + 1).padStart(2, '0')}
                    </span>
                  </div>

                  {/* Green icon badge — filled */}
                  <div className="absolute top-5 left-5 z-10 w-10 h-10 bg-emerald-600/20 border border-emerald-600/30 flex items-center justify-center group-hover:bg-emerald-600/30 group-hover:border-emerald-600/60 transition-all duration-500">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8 z-10">
                    ...
                    <div className="flex items-center gap-2 mt-3 text-emerald-600 group-hover:translate-x-1 transition-transform duration-300">
                      <span className="text-xs uppercase tracking-[0.2em]" style={{ fontFamily: 'var(--font-sans)' }}>Explore</span>
                      <ArrowRight size={14} />
                    </div>
                  </div>

                  <div className="absolute bottom-0 left-0 right-0 h-[3px] bg-gradient-to-r from-emerald-600 to-emerald-400 z-10" />
                </Link>
              </motion.div>
            );
          })}
    ...
    <section ref={containerRef} className="bg-navy-950 py-24 sm:py-32 lg:py-40 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 mb-12 sm:mb-16">
        ...
        >
          <div>
            <div className="w-12 h-[3px] bg-emerald-600 mb-6" />
            <p className="text-emerald-600/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>Projects</p>
            <h2 className="font-heading text-white leading-[0.92]" style={{ fontSize: 'clamp(2rem, 5vw, 4rem)' }}>
              Built to <span className="text-emerald-600">Last</span>
            </h2>
          </div>
          <Link
            to="/projects"
          ...
          {projects.items.map((project, i) => (
            ...
            >
              <div className="aspect-[3/4] overflow-hidden relative">
                ...
                <div className="absolute inset-0 border-2 border-transparent group-hover:border-emerald-600/40 transition-colors duration-500 z-10" />

                <div className="absolute top-5 left-5 z-10">
                  <span className="bg-emerald-600/90 text-navy-950 text-[10px] uppercase tracking-[0.2em] px-3 py-1.5 font-semibold" style={{ fontFamily: 'var(--font-sans)' }}>
                    {project.category}
                  </span>
                </div>
              </div>
  ...
  return (
    <section ref={ref} className="relative bg-navy-950 overflow-hidden">
      <div className="absolute inset-0">
        <div className="absolute top-1/2 left-1/4 -translate-y-1/2 w-48 h-48 bg-emerald-600/5 rounded-full blur-3xl" />
        <div className="absolute top-1/2 right-1/4 -translate-y-1/2 w-48 h-48 bg-emerald-600/5 rounded-full blur-3xl" />
      </div>
      <div className="absolute top-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-emerald-600/40 to-transparent" />
      <div className="absolute bottom-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-emerald-600/40 to-transparent" />
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-20 sm:py-24">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-16">
          {stats.map((stat, i) => (
            ...
            >
              <div
                className="font-heading text-emerald-600 leading-none font-bold"
                style={{ fontSize: 'clamp(2.8rem, 6vw, 5rem)', textShadow: '0 0 40px rgba(5,150,105,0.15)' }}
              >
              ...
              {i < stats.length - 1 && (
                <div className="hidden lg:block absolute right-0 top-1/2 -translate-y-1/2 h-16 w-[1px] bg-gradient-to-b from-transparent via-emerald-600/15 to-transparent" />
              )}
            </motion.div>
          ))}
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <h2 className="font-heading text-white leading-[0.95] mb-8" style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)' }}>
              Moving Zimbabwe<br />
              <span className="text-emerald-600">Forward</span>
            </h2>
            ...
            <div className="flex gap-10 sm:gap-16">
              <div>
                <div className="text-emerald-600 font-heading text-3xl sm:text-4xl leading-none font-bold">{business.established}</div>
                <div className="text-white/30 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Founded</div>
              </div>
              <div>
                <div className="text-emerald-600 font-heading text-3xl sm:text-4xl leading-none font-bold">{business.projectsCompleted}</div>
                <div className="text-white/30 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Deliveries</div>
              </div>
              <div>
                <div className="text-emerald-600 font-heading text-3xl sm:text-4xl leading-none font-bold">99%</div>
          ...
          >
            <div className="relative">
              ...
              <div className="absolute -top-4 -right-4 sm:-right-6 bg-emerald-600 text-navy-950 p-5 sm:p-7 shadow-2xl">
...
function WhyChooseUs() {
  ...
  const points = [
    { title: 'Landscape Architecture', desc: 'Full landscape master plans that integrate hardscaping, softscaping, irrigation, and lighting.' },
    { title: '3D Visualization', desc: 'See your project before ground is broken with photorealistic 3D renders and walkthrough animations.' },
    { title: 'Project Management', desc: 'End-to-end project management from design through construction to handover.' },
    { title: 'Sustainable Design', desc: 'Rainwater harvesting, solar integration, indigenous planting, and water-wise irrigation systems.' },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            <img
              ...
              loading="lazy"
            />
            <div className="absolute -top-3 -left-3 w-20 h-20 border-t-2 border-l-2 border-emerald-600/40" />
            <div className="absolute -bottom-3 -right-3 w-20 h-20 border-b-2 border-r-2 border-emerald-600/40" />
          </motion.div>
          ...
          >
            <div className="w-12 h-[3px] bg-emerald-600 mb-6" />
            <p className="text-emerald-600/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>The Advantage</p>
            <h2 className="font-heading text-white leading-[0.95] mb-12" style={{ fontSize: 'clamp(2rem, 4.5vw, 3rem)' }}>
              Why Choose <span className="text-emerald-600">{business.name}</span>
            </h2>
              ...
              {points.map((point, i) => (
                ...
                >
                  <div className="shrink-0 mt-1">
                    <div className="w-8 h-8 bg-emerald-600/10 border border-emerald-600/30 flex items-center justify-center">
  ...
  return (
    <section ref={ref} className="relative bg-navy-950 py-24 sm:py-32 lg:py-40 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        >
          <Quotes size={48} weight="fill" className="text-emerald-600/15 mx-auto mb-8" />
              ...
              <div className="flex flex-col items-center gap-3">
                {t.avatar && (
                  <img
                    src={t.avatar}
                    alt={t.name}
                    className="w-12 h-12 rounded-full object-cover object-center border-2 border-emerald-600/30"
                    loading="lazy"
                  />
                )}
                ...
                <div className="flex items-center gap-0.5 mt-1">
                  {[...Array(t.rating)].map((_, i) => (
                    <Star key={i} size={12} weight="fill" className="text-emerald-600" />
                  ))}
                </div>
              </div>
            </motion.div>
          ...
          <div className="flex items-center justify-center gap-6 mt-12">
            <button onClick={prev} className="w-10 h-10 border border-white/10 flex items-center justify-center text-white/30 hover:text-emerald-600 hover:border-emerald-600/30 transition-colors duration-300" aria-label="Previous testimonial">
              <CaretLeft size={16} />
            </button>
            <div className="flex gap-2">
              {homeTestimonials.map((_, i) => (
                <button key={i} onClick={() => setActive(i)} className={`h-[2px] transition-all duration-500 ${i === active ? 'w-10 bg-emerald-600' : 'w-3 bg-white/10 hover:bg-white/25'}`} aria-label={`Go to testimonial ${i + 1}`} />
              ))}
            </div>
            <button onClick={next} className="w-10 h-10 border border-white/10 flex items-center justify-center text-white/30 hover:text-emerald-600 hover:border-emerald-600/30 transition-colors duration-300" aria-label="Next testimonial">
              <CaretRight size={16} />
            </button>
          </div>
        </motion.div>
  ...
  return (
    <section ref={ref} className="relative py-28 sm:py-36 lg:py-48 overflow-hidden">
      ...
      <div className="relative z-20 max-w-5xl mx-auto px-5 sm:px-8 lg:px-12 text-center">
        ...
        >
          <div className="w-16 h-[3px] bg-emerald-600 mx-auto mb-8" />
          ...
          >
            YOUR CARGO<br />
            <span className="text-emerald-600">OUR COMMITMENT</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/contact"
              className="group relative inline-flex items-center gap-3 bg-emerald-600 text-navy-950 px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold transition-all duration-500 hover:bg-emerald-500 hover:shadow-xl hover:shadow-emerald-600/25"
              style={{ fontFamily: 'var(--font-sans)' }}
            >
            ...
            <a
              ...
              className="group inline-flex items-center gap-3 border border-emerald-600/40 text-emerald-500 px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold transition-all duration-500 hover:bg-emerald-600/10 hover:border-emerald-600/60"
              style={{ fontFamily: 'var(--font-sans)' }}
            >
